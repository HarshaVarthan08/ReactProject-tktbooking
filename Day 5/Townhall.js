...
const Ghandhi= () => {
  const roomsData = [
    { id: 1, name: 'Executive Suite',moviename:'KARPAGAM CINEMAS',price: 250, location: 'GANDHIPURAM,BUS STAND', image:salar,movie:'SALAR',showdate:'23/12/23',showtime:'5:00AM'},
    { id: 2, name: 'Deluxe Room',moviename:'KARPAGAM CINEMAS',price: 150, location: 'GANDHIPURAM,CROSS CUT ROAD', image:joe,movie:'JOE',showdate:'23/12/23',showtime:'5:00AM'},
